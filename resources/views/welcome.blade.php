...
<head>
    ...
    <title>Jesus Castañeda Portfolio</title>
...
<body>
    <div class="container-fluid">
        <div class="col-md-2 col-md-offset-10 visible-lg menu">
            <ul class="list-unstyled">
                <li id="home" >
                    <a href="#"><i class="glyphicon glyphicon-home"></i> Home</a>
                </li>
                <li id="portfolio" >
                    <a href="#"><i class="glyphicon glyphicon-briefcase"> </i> Portfolio</a>
                </li>
                <li id="portfolio" >
                    <a href="#"><i class="glyphicon glyphicon-list"> </i> Skills</a>
                </li>
                <li id="contact" >
        ...
        <div class="row">
            <div class="cover">
                <div class="col-md-3 col-md-offset-9 hidden-lg menu-xs text-center">
                ...
                <div class="col-md-4 col-md-offset-4 text-center social">
                    ...
                    <a href="http://www.codepen.io/jesuscastaneda86" target="_blank"><img data-toggle="tooltip" data-placement="bottom" title="Codepen" src="images/codepen.png" alt="codepen"></a>
                ...
                <div class="col-md-12 text-center copy hidden-xs">
